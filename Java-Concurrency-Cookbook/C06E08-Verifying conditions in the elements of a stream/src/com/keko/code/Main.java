...
public class Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("Salary > 0 : " + condition);
		...
		/*
		 * we sort the stream by salary using the sorted() method, passing Comparator
		 * expressed as a lambda expression, and use the findFirst() method to obtain,
		 * in this case, the Person object with the lowest salary:
		 */
